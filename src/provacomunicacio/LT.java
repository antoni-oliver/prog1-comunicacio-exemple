package provacomunicacio; // canviau-ho pel vostre package <----
 ...
 *      i els ignora.
 * 
 *  - LT.readLineChar(): lectura d'una línia
 *      Llegeix els caràcters de la línia actual
 *      (de la resta de la línia si s'ha consumit parcialment amb readChar)
 *      i els retorna en un array de caràcters.
 *  - LT.readLine(): lectura d'una línia
 *      Llegeix els caràcters de la línia actual
 *      (de la resta de la línia si s'ha consumit parcialment amb readChar)
 *      i els retorna en una String.
 * 
 ...
 * versió 2.3:
 *  - Canviat readLine a readLineChar.
 *  - Afegit readLine, que retorna String.
 * versió 2.2:
 *  - Mètode readLong.
 *  - Privatitzat read.
...
public class LT {
    ...
    /**
     * Llegeix una línia de text retornant-la en format String.
     *
     * @return l'String a partir de la línia de text llegida
     */
